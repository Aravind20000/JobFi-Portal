...
<head>
   ...
   <?php echo "<h3>Welcome " . $_SESSION['username'] . "</h3><br>"; ?>
    ...
    while ($row =mysqli_fetch_array($query)){
            ...
            <li><span style="color:#0fd84c;font-size: 35px;"><?php echo $row['username'] ?></span><span style="position: absolute;left: 38em;font-size: 35px;"><?php echo $row2['skillscore'] ;?></span> 
